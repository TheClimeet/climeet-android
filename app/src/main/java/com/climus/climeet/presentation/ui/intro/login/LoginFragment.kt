...
class LoginFragment : BaseFragment<FragmentLoginBinding>(R.layout.fragment_login) {
    ...
    private fun setBtnListener() {
        binding.btnClimerLogin.setOnClickListener {
            ...
            binding.btnClimerLogin.setBackgroundResource(R.drawable.rect_mainfill_nostroke_15radius)
        ...
        binding.btnAdminLogin.setOnClickListener {
            ...
            binding.btnAdminLogin.setBackgroundResource(R.drawable.rect_mainfill_nostroke_15radius)
            CoroutineScope(Dispatchers.Main).launch {
                delay(300)
