...
class PopularShortsRVAdapter (private val shortsList: List<ShortsSimpleResponse>) : RecyclerView.Adapter<PopularShortsRVAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemPopularShortsBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(shorts: ShortsSimpleResponse){
            ...
            binding.tvPopularShortsLevel.text = shorts.difficulty.toString()
