...
class PopularShortsRVAdapter (private val shortsList: List<ShortsItem>) : RecyclerView.Adapter<PopularShortsRVAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemPopularShortsBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(shorts: ShortsItem){
            ...
            binding.tvPopularShortsLevel.text = shorts.gymDifficultyName
